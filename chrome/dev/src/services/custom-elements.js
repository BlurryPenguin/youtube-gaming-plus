...
*/
		...
		if (d && (null === f || 'http://www.w3.org/1999/xhtml' === f) && (d = W(d, c)))
			try {
				...
				if (void 0 === e.__CE_state || void 0 === e.__CE_definition)
					throw Error(
						"Failed to construct '" + c + "': The returned value was not constructed with the HTMLElement constructor.",
					);
				if ('http://www.w3.org/1999/xhtml' !== e.namespaceURI)
					throw Error(
						"Failed to construct '" + c + "': The constructed element's namespace must be the HTML namespace.",
					);
				if (e.hasAttributes())
	...
	function X(a) {
		...
		void 0 === ErrorEvent.prototype.initErrorEvent
			? (e = new ErrorEvent('error', { cancelable: !0, message: b, filename: c, lineno: f, colno: d, error: a }))
